...
def render():
    ...
    # ===========================
    subsection_title("Dataset Summary & Analysis")
    st.markdown(
        """
        *Dataset Summary:*  
        ...
        *Types of Analysis Performed:*  
        - *Trend Analysis:* Identify patterns and frequency of disaster events over time.  
        - *Impact Assessment:* Quantify human and economic impact per disaster type and region.  
        - *Geospatial Visualization:* Map disaster hotspots globally using interactive maps.  
        - *Alert & Severity Monitoring:* Track live alerts from GDACS for timely situational awareness.  
        """
    )
    # ===========================
    ...
    try:
        ...
        st.warning("⚠ Dataset not found. Please ensure 'data/emdat_cleaned.csv' exists.")
        return
